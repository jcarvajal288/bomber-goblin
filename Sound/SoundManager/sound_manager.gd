...
func _on_play_sound(sound_effect: Sounds.SoundEffect, sound_position: Vector2) -> void:
	...
	elif sound_effect == Sounds.SoundEffect.DWARF_FIGHTER_ATTACK: 
	...
	elif sound_effect == Sounds.SoundEffect.LIGHT_BOMB: 
		play_sound_at_position($LightBomb, sound_position)
